        ...
        <div className="mx-auto px-4 py-12 sm:px-6 lg:px-16 bg-[#f4f5ef] text-[var(--brand-deep)] font-body">
            ...
            <div className="mt-8 space-y-6">
                ...
                <section>
                    ...
                    <p className="mt-2">We do not sell or trade your personal details to third parties.</p>
                </section>
                ...
                <section>
                    ...
                    <ul className="list-disc ml-6">
                        <li>Trusted service providers (IT and hosting providers)</li>
                ...
                <section>
                    ...
                    <p>We take appropriate measures to keep your personal information secure and prevent unauthorized access, disclosure, alteration, or destruction.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-medium">7. How Long We Keep Your Information</h2>
                    <p>We keep your personal data only for as long as necessary to fulfill the purposes for which it was collected.</p>
                </section>
