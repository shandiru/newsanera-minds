...
export default function OrgExpect() {
  useAOS()
   ...
   const items = [
    <>
      <span className="font-semibold text-[var(--brand-teal)]">Therapist-led sessions that feel real and relevant.</span>{" "}
      Grounded, practical, and designed to fit naturally into the working day.
    </>,
    <>
      <span className="font-semibold text-[var(--brand-teal)]">Tailored wellbeing assessments.</span>{" "}
      We start by understanding your organisation’s needs, then design workshops that meet them.
    </>,
    <>
      <span className="font-semibold text-[var(--brand-teal)]">Training for managers and leaders.</span>{" "}
      Learn how to recognise signs of stress and create psychologically safe spaces.
    </>,
    <>
      <span className="font-semibold text-[var(--brand-teal)]">Coping and resilience strategies for staff.</span>{" "}
      CBT techniques and stress management tools that people can apply instantly.
    </>,
    <>
      <span className="font-semibold text-[var(--brand-teal)]">Flexible formats.</span>{" "}
      From 60–90 minute virtual sessions to full-day training  whatever works for your team.
    </>,
    <>
      <span className="font-semibold text-[var(--brand-teal)]">E-learning: supporting life’s hardest moments.</span>{" "}
